...
# Parameters
UPDATE_COUNT = 2  # no. of times to update loss for each EPOCHS
BUFFER_SIZE = 60000
BATCH_SIZE = 32
CLASSES = 10
INPUT_DIM = 28
...
model_dir = './'
MODEL_FILENAME = model_dir + 'rnn_model.h5'
METRICS_FILENAME = model_dir + 'rnn_metrics.png'
RESULTS_FILENAME = model_dir + 'rnn_results.png'
...
def createRNN():
    fmodel = keras.Sequential(
        [
            keras.Input(shape=(None, INPUT_DIM), name="digits"),
